...
``` r
model3.ILIpneu <- glm(Count ~ Time + PctOvercrowded + PctMultigen + PctWhite + PctBelowPovThresh + MedianIncome + PctEssEmpl + offset(log(Population/10000)), family=quasipoisson, data=designResponse)
...
| :---------------- | -------: | -: | ---------------: |
| Time              | 1.000000 |  1 |         1.000000 |
| PctOvercrowded    | 2.276243 |  3 |         1.146929 |
| PctMultigen       | 3.865827 |  3 |         1.252777 |
...
|                   | exp(Estimate) |   p-value | 2.5 % | 97.5 % |
| :---------------- | ------------: | --------: | ----: | -----: |
| (Intercept)       |          2.32 | 0.0000000 |  1.69 |   3.20 |
| Time              |          1.04 | 0.0000000 |  1.04 |   1.05 |
| PctOvercrowdedQ2  |          1.36 | 0.0000000 |  1.28 |   1.45 |
| PctOvercrowdedQ3  |          1.43 | 0.0000000 |  1.34 |   1.52 |
| PctOvercrowdedQ4  |          1.62 | 0.0000000 |  1.50 |   1.76 |
| PctMultigenQ2     |          1.01 | 0.8076287 |  0.94 |   1.08 |
| PctMultigenQ3     |          1.08 | 0.0697316 |  1.00 |   1.16 |
| PctMultigenQ4     |          1.27 | 0.0000001 |  1.15 |   1.39 |
...
``` r
model4.ILIpneu <- glm(Count ~ Time + PctOvercrowded + PctMultigen + BPHIGH_CrudePrev + DIABETES_CrudePrev + CHD_CrudePrev + OBESITY_CrudePrev + COPD_CrudePrev + CSMOKING_CrudePrev + PctWhite  + PctBelowPovThresh + MedianIncome + PctEssEmpl + offset(log(Population/10000)), family=quasipoisson, data=designResponse)
...
| :------------------ | --------: | -: | ---------------: |
| Time                |  1.000000 |  1 |         1.000000 |
| PctOvercrowded      |  3.504577 |  3 |         1.232459 |
| PctMultigen         |  6.205648 |  3 |         1.355599 |
...
``` r
# Re-fit model without COPD
model4.ILIpneu <- glm(Count ~ Time + PctOvercrowded + PctMultigen + BPHIGH_CrudePrev + DIABETES_CrudePrev + CHD_CrudePrev + OBESITY_CrudePrev + CSMOKING_CrudePrev + PctWhite  + PctBelowPovThresh + MedianIncome + PctEssEmpl + offset(log(Population/10000)), family=quasipoisson, data=designResponse)
...
| :------------------ | --------: | -: | ---------------: |
| Time                |  1.000000 |  1 |         1.000000 |
| PctOvercrowded      |  3.380065 |  3 |         1.225051 |
| PctMultigen         |  5.902429 |  3 |         1.344328 |
...
``` r
# Re-fit model without COPD and hypertension
model4.ILIpneu <- glm(Count ~ Time + PctOvercrowded + PctMultigen + DIABETES_CrudePrev + CHD_CrudePrev + OBESITY_CrudePrev + CSMOKING_CrudePrev + PctWhite  + PctBelowPovThresh + MedianIncome + PctEssEmpl + offset(log(Population/10000)), family=quasipoisson, data=designResponse)
...
| :------------------ | --------: | -: | ---------------: |
| Time                |  1.000000 |  1 |         1.000000 |
| PctOvercrowded      |  2.793404 |  3 |         1.186740 |
| PctMultigen         |  5.584043 |  3 |         1.331961 |
...
model4.ILIpneu <- glm(Count ~ Time + PctOvercrowded + PctMultigen + CHD_CrudePrev + OBESITY_CrudePrev + CSMOKING_CrudePrev + PctWhite  + PctBelowPovThresh + MedianIncome + PctEssEmpl + offset(log(Population/10000)), family=quasipoisson, data=designResponse)
...
| :------------------ | -------: | -: | ---------------: |
| Time                | 1.000000 |  1 |         1.000000 |
| PctOvercrowded      | 2.790353 |  3 |         1.186524 |
| PctMultigen         | 5.446228 |  3 |         1.326425 |
...
|                     | exp(Estimate) |   p-value | 2.5 % | 97.5 % |
| :------------------ | ------------: | --------: | ----: | -----: |
| (Intercept)         |         20.72 | 0.0000000 | 14.02 |  30.62 |
| Time                |          1.04 | 0.0000000 |  1.04 |   1.05 |
| PctOvercrowdedQ2    |          1.22 | 0.0000000 |  1.14 |   1.29 |
| PctOvercrowdedQ3    |          1.44 | 0.0000000 |  1.35 |   1.54 |
| PctOvercrowdedQ4    |          1.58 | 0.0000000 |  1.46 |   1.70 |
| PctMultigenQ2       |          1.17 | 0.0000200 |  1.09 |   1.26 |
| PctMultigenQ3       |          1.38 | 0.0000000 |  1.27 |   1.50 |
| PctMultigenQ4       |          1.54 | 0.0000000 |  1.40 |   1.70 |
...
model5.INLAformula <- Count ~ 1 + f(ZipID, model="bym", offset(Population/10000), graph=NYCadj) + f(ZipID2, Time, model="rw1") + Time + PctOvercrowded + PctMultigen + CHD_CrudePrev + OBESITY_CrudePrev + CSMOKING_CrudePrev + PctWhite + PctBelowPovThresh + MedianIncome + PctEssEmpl
...
| :------------------ | ------------: | --------: | ---------: | ---------: | ---: |
| (Intercept)         |          7.70 | 0.8128972 |       1.54 |      37.64 | 7.79 |
| Time                |          1.04 | 0.0008312 |       1.04 |       1.04 | 1.04 |
| PctOvercrowdedQ2    |          1.45 | 0.1295751 |       1.13 |       1.87 | 1.44 |
| PctOvercrowdedQ3    |          1.41 | 0.1388371 |       1.08 |       1.86 | 1.41 |
| PctOvercrowdedQ4    |          1.67 | 0.2072501 |       1.12 |       2.52 | 1.66 |
| PctMultigenQ2       |          1.48 | 0.1717768 |       1.05 |       2.07 | 1.48 |
| PctMultigenQ3       |          1.89 | 0.1975943 |       1.28 |       2.78 | 1.89 |
| PctMultigenQ4       |          1.77 | 0.2340046 |       1.11 |       2.79 | 1.78 |
| CHD\_CrudePrev      |          0.92 | 0.0576194 |       0.82 |       1.03 | 0.92 |
| OBESITY\_CrudePrev  |          0.97 | 0.0154450 |       0.94 |       1.00 | 0.97 |
| CSMOKING\_CrudePrev |          1.08 | 0.0409454 |       1.00 |       1.17 | 1.07 |
